...
| doc | covers |
|---|---|
| [docs/transcription.md](docs/transcription.md) | 💬 Whisper live transcription (AC-power-driven), heartbeat + output watchdog, 🎙️ "Ce tocmai am spus" picker (**a menu row since 2026-09-17, no shortcut** — it gave ⌘⌃V to the clipboard→notes append; `TranscriptDistiller`), the `whisper-transcribe` Python engine (PortAudio discipline, supervised threads, quiet crashes) |
