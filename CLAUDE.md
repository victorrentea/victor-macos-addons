...
| [docs/hands-off.md](docs/hands-off.md) | ✋🔒 the warning an agent raises while it drives the GUI: amber frame + cursor badge + four slowly pulsing 🔒 in the screen corners (`/hands-off/*` HTTP API, `./hands-off.sh` → `~/bin/hands-off`) |
