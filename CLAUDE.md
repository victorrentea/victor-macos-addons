...
| [docs/teams-web.md](docs/teams-web.md) | 🎙️ Teams web as a guest (`chrome-extension/teams-guest-audio.js`): noise suppression Off in every meeting (the per-meeting `localStorage` key), screen share with the "system audio" switch pre-set + raw stereo sound (`audioSelection: 'preferred'`) |
