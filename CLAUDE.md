...
| [docs/hotkeys-launchers.md](docs/hotkeys-launchers.md) | 🤖 terminals ⌘⌃C/Q/T + quarter placement + tiling, 📝 ⌘⌃N notes doc, 📕⌘⌃K / 📧⌘⌃G / 📅⌘⌃L openers, ✉️ ⌘⌃M TO DO mail (`GmailCompose`), 📋 ⌘⌃Z/E/R snippet paste, 🎯 ⌘⌃D Wispr Relay bind, ⌘⌃⌥D dark mode, Wheel×2 re-paste, 🔎 Cmd+scroll terminal font zoom (`TerminalZoomSizeLock`) |
