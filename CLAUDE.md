...
| [docs/displays-projector.md](docs/displays-projector.md) | 🖥️ auto display arrangement (`DisplayArrangementManager`, `KnownDisplays`), 🔴 presentation detection + aggressive 😶😶😶 silent-transcription warning, 🔊 Zoom share-picker prep (`ZoomSharePrep`), ▶️ Zoom join-preview auto-press (`ZoomJoinAutoStart`) |
